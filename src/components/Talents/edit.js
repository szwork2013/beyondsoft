      ...
      return (
        <div>
          <div style={{ marginBottom: 8 }}>
            ...
            <Link to={hasSelected ? `/Recommend?TalentsCode=${selectedRowKeys}`  : '/Recommend'}><Button type="primary">推荐</Button></Link><span className="ant-divider"></span>
            <Link to={hasSelected ? `/Collect?TalentsCode=${selectedRowKeys}`  : '/Collect'}><Button type="primary">收藏</Button></Link>
          </div>
